...
/// <summary>
/// The contents of <c>l2w-site.json</c> at the root of a built site: enough for a person or a
/// script to say "this folder was generated by LMS 2 Website, from this export, on this day" —
/// and nothing about the machine that built it.
/// </summary>
public sealed record SiteMarker(
    string Generator,
    string Version,
    string Course,
    string Source,
    ...
    int Files)
{
    public static SiteMarker For(CourseSite course, SiteBuildResult result) => new(
        Generator: L2W.Product,
        Version:   L2W.Version,
        Course:    course.Title,
        Source:    Path.GetFileName(course.SourcePath),
        Producer:  course.Producer.ToString(),
        BuiltUtc:  DateTime.UtcNow.ToString("yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture),
...
///   l2w-site.json               the mark that this folder was generated by this app
/// </code>
/// </summary>
public static class SiteBuilder
{
        ...
        CancellationToken ct = default)
    {
        ...
        // The mark that says this folder is a generated course site, so the app (and anyone
    ...
    /// <summary>The marker file is read by people as often as by scripts, so it is indented.</summary>
    ...
    private static string Readme(CourseSite course, SiteBuildResult result) =>
        ...
        This repository is a generated course site: it is named `{L2W.RepoPrefix}…`, carries the
        `{L2W.Topic}` topic, and holds `{L2W.MarkerFileName}`. Anything you write here by hand is
